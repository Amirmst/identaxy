...
class CardOverlay: UIView {
    static func left() -> UIView {
        let overlay = UIView()
        let leftTextView = SampleOverlayLabelView(title: "FAKE",
                                                  color: .sampleRed,
    ...
    static func up() -> UIView {
        let overlay = UIView()
        let upTextView = SampleOverlayLabelView(title: "UNKNOWN",
                                                color: .sampleBlue,
    ...
    static func right() -> UIView {
        let overlay = UIView()
        let rightTextView = SampleOverlayLabelView(title: "REAL",
                                                   color: .sampleGreen,
                                                   rotation: -CGFloat.pi/10)
...
//    static func left() -> UIView {
//        let overlay = UIView()
//        let leftTextView = SampleOverlayLabelView(imageName: "fake",
//                                                  rotation: CGFloat.pi/10)
//        overlay.addSubview(leftTextView)
//        leftTextView.anchor(top: overlay.topAnchor,
//                            right: overlay.rightAnchor,
...
////    static func up() -> UIView {
////        let overlay = UIView()
////        let upTextView = SampleOverlayLabelView(title: "DON'T KNOW",
////                                                color: .sampleBlue,
////                                                rotation: -CGFloat.pi/20)
////        overlay.addSubview(upTextView)
////        upTextView.anchor(bottom: overlay.bottomAnchor, paddingBottom: 20)
...
//    static func right() -> UIView {
//        let overlay = UIView()
//        let rightTextView = SampleOverlayLabelView(imageName: "real",
//                                                   rotation: -CGFloat.pi/10)
//        overlay.addSubview(rightTextView)
//        rightTextView.anchor(top: overlay.topAnchor,
//                             left: overlay.leftAnchor,
...
//
//fileprivate class SampleOverlayLabelView: UIView {
//    init(imageName: String, rotation: CGFloat) {
//        super.init(frame: CGRect.zero)
//
