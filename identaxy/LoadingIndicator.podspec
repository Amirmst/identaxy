#
#  Be sure to run `pod spec lint LoadingIndicator.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Lexi Cepak" => "CepakA@advisory.com" }
  # Or just: spec.author    = "Lexi Cepak"
  # spec.authors            = { "Lexi Cepak" => "CepakA@advisory.com" }
  # spec.social_media_url   = "https://twitter.com/Lexi Cepak"
